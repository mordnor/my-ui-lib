"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const ne=require("react"),zn=require("react-dom"),M=require("clsx");function Un(r){const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(r){for(const e in r)if(e!=="default"){const n=Object.getOwnPropertyDescriptor(r,e);Object.defineProperty(t,e,n.get?n:{enumerable:!0,get:()=>r[e]})}}return t.default=r,Object.freeze(t)}const v=Un(ne);var Xt={exports:{}},Be={};/**
 * @license React
...
`,Xr={root:"p-ink"},pe=F.extend({defaultProps:{__TYPE:"Ripple",children:void 0},css:{styles:qr,classes:Xr},getProps:function(t){return S.getMergedProps(t,pe.defaultProps)},getOtherProps:function(t){return S.getDiffProps(t,pe.defaultProps)}});function Ut(r,t){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);t&&(n=n.filter(function(a){return Object.getOwnPropertyDescriptor(r,a).enumerable})),e.push.apply(e,n)}return e}function Zr(r){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?Ut(Object(e),!0).forEach(function(n){Br(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):Ut(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}var on=v.memo(v.forwardRef(function(r,t){var e=v.useState(!1),n=Vr(e,2),a=n[0],o=n[1],s=v.useRef(null),i=v.useRef(null),l=Oe(),u=v.useContext(oe),c=pe.getProps(r,u),f=u&&u.ripple||ae.ripple,g={props:c};ye(pe.css.styles,{name:"ripple",manual:!f});var p=pe.setMetaData(Zr({},g)),b=p.ptm,h=p.cx,x=function(){return s.current&&s.current.parentElement},m=function(){i.current&&i.current.addEventListener("pointerdown",w)},y=function(){i.current&&i.current.removeEventListener("pointerdown",w)},w=function(A){var K=P.getOffset(i.current),Z=A.pageX-K.left+document.body.scrollTop-P.getWidth(s.current)/2,ie=A.pageY-K.top+document.body.scrollLeft-P.getHeight(s.current)/2;C(Z,ie)},C=function(A,K){!s.current||getComputedStyle(s.current,null).display==="none"||(P.removeClass(s.current,"p-ink-active"),H(),s.current.style.top=K+"px",s.current.style.left=A+"px",P.addClass(s.current,"p-ink-active"))},k=function(A){P.removeClass(A.currentTarget,"p-ink-active")},H=function(){if(s.current&&!P.getHeight(s.current)&&!P.getWidth(s.current)){var A=Math.max(P.getOuterWidth(i.current),P.getOuterHeight(i.current));s.current.style.height=A+"px",s.current.style.width=A+"px"}};if(v.useImperativeHandle(t,function(){return{props:c,getInk:function(){return s.current},getTarget:function(){return i.current}}}),Ue(function(){o(!0)}),ce(function(){a&&s.current&&(i.current=x(),H(),m())},[a]),ce(function(){s.current&&!i.current&&(i.current=x(),H(),m())}),ge(function(){s.current&&(i.current=null,y())}),!f)return null;var W=l({"aria-hidden":!0,className:U(h("root"))},pe.getOtherProps(c),b("root"));return v.createElement("span",lt({role:"presentation",ref:s},W,{onAnimationEnd:k}))}));on.displayName="Ripple";function Gr(r){if(Array.isArray(r))return r}function Jr(r,t){var e=r==null?null:typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(e!=null){var n,a,o,s,i=[],l=!0,u=!1;try{if(o=(e=e.call(r)).next,t!==0)for(;!(l=(n=o.call(e)).done)&&(i.push(n.value),i.length!==t);l=!0);}catch(c){u=!0,a=c}finally{try{if(!l&&e.return!=null&&(s=e.return(),Object(s)!==s))return}finally{if(u)throw a}}return i}}function Kt(r,t){(t==null||t>r.length)&&(t=r.length);for(var e=0,n=Array(t);e<t;e++)n[e]=r[e];return n}function Qr(r,t){if(r){if(typeof r=="string")return Kt(r,t);var e={}.toString.call(r).slice(8,-1);return e==="Object"&&r.constructor&&(e=r.constructor.name),e==="Map"||e==="Set"?Array.from(r):e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?Kt(r,t):void 0}}function ea(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function ta(r,t){return Gr(r)||Jr(r,t)||Qr(r,t)||ea()}var ut={defaultProps:{__TYPE:"Portal",element:null,appendTo:null,visible:!1,onMounted:null,onUnmounted:null,children:void 0},getProps:function(t){return S.getMergedProps(t,ut.defaultProps)},getOtherProps:function(t){return S.getDiffProps(t,ut.defaultProps)}},sn=v.memo(function(r){var t=ut.getProps(r),e=v.useContext(oe),n=v.useState(t.visible&&P.isClient()),a=ta(n,2),o=a[0],s=a[1];Ue(function(){P.isClient()&&!o&&(s(!0),t.onMounted&&t.onMounted())}),ce(function(){t.onMounted&&t.onMounted()},[o]),ge(function(){t.onUnmounted&&t.onUnmounted()});var i=t.element||t.children;if(i&&o){var l=t.appendTo||e&&e.appendTo||ae.appendTo;return S.isFunction(l)&&(l=l()),l||(l=document.body),l==="self"?i:zn.createPortal(i,l)}return null});sn.displayName="Portal";function We(){return We=Object.assign?Object.assign.bind():function(r){for(var t=1;t<arguments.length;t++){var e=arguments[t];for(var n in e)({}).hasOwnProperty.call(e,n)&&(r[n]=e[n])}return r},We.apply(null,arguments)}function Ee(r){"@babel/helpers - typeof";return Ee=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},Ee(r)}function na(r,t){if(Ee(r)!="object"||!r)return r;var e=r[Symbol.toPrimitive];if(e!==void 0){var n=e.call(r,t);if(Ee(n)!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(r)}function ra(r){var t=na(r,"string");return Ee(t)=="symbol"?t:t+""}function ln(r,t,e){return(t=ra(t))in r?Object.defineProperty(r,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):r[t]=e,r}function ct(r,t){(t==null||t>r.length)&&(t=r.length);for(var e=0,n=Array(t);e<t;e++)n[e]=r[e];return n}function aa(r){if(Array.isArray(r))return ct(r)}function oa(r){if(typeof Symbol<"u"&&r[Symbol.iterator]!=null||r["@@iterator"]!=null)return Array.from(r)}function un(r,t){if(r){if(typeof r=="string")return ct(r,t);var e={}.toString.call(r).slice(8,-1);return e==="Object"&&r.constructor&&(e=r.constructor.name),e==="Map"||e==="Set"?Array.from(r):e==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?ct(r,t):void 0}}function ia(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function sa(r){return aa(r)||oa(r)||un(r)||ia()}function la(r){if(Array.isArray(r))return r}function ua(r,t){var e=r==null?null:typeof Symbol<"u"&&r[Symbol.iterator]||r["@@iterator"];if(e!=null){var n,a,o,s,i=[],l=!0,u=!1;try{if(o=(e=e.call(r)).next,t!==0)for(;!(l=(n=o.call(e)).done)&&(i.push(n.value),i.length!==t);l=!0);}catch(c){u=!0,a=c}finally{try{if(!l&&e.return!=null&&(s=e.return(),Object(s)!==s))return}finally{if(u)throw a}}return i}}function ca(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function fe(r,t){return la(r)||ua(r,t)||un(r,t)||ca()}var da={root:function(t){var e=t.positionState,n=t.classNameState;return U("p-tooltip p-component",ln({},"p-tooltip-".concat(e),!0),n)},arrow:"p-tooltip-arrow",text:"p-tooltip-text"},fa={arrow:function(t){var e=t.context;return{top:e.bottom?"0":e.right||e.left||!e.right&&!e.left&&!e.top&&!e.bottom?"50%":null,bottom:e.top?"0":null,left:e.right||!e.right&&!e.left&&!e.top&&!e.bottom?"0":e.top||e.bottom?"50%":null,right:e.left?"0":null}}},pa=`
@layer primereact {
    .p-tooltip {
        position: absolute;
        padding: .25em .5rem;
...
`,je=F.extend({defaultProps:{__TYPE:"Tooltip",appendTo:null,at:null,autoHide:!0,autoZIndex:!0,baseZIndex:0,className:null,closeOnEscape:!1,content:null,disabled:!1,event:null,hideDelay:0,hideEvent:"mouseleave",id:null,mouseTrack:!1,mouseTrackLeft:5,mouseTrackTop:5,my:null,onBeforeHide:null,onBeforeShow:null,onHide:null,onShow:null,position:"right",showDelay:0,showEvent:"mouseenter",showOnDisabled:!1,style:null,target:null,updateDelay:0,children:void 0},css:{classes:da,styles:pa,inlineStyles:fa}});function Yt(r,t){var e=Object.keys(r);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(r);t&&(n=n.filter(function(a){return Object.getOwnPropertyDescriptor(r,a).enumerable})),e.push.apply(e,n)}return e}function ga(r){for(var t=1;t<arguments.length;t++){var e=arguments[t]!=null?arguments[t]:{};t%2?Yt(Object(e),!0).forEach(function(n){ln(r,n,e[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(r,Object.getOwnPropertyDescriptors(e)):Yt(Object(e)).forEach(function(n){Object.defineProperty(r,n,Object.getOwnPropertyDescriptor(e,n))})}return r}var cn=v.memo(v.forwardRef(function(r,t){var e=Oe(),n=v.useContext(oe),a=je.getProps(r,n),o=v.useState(!1),s=fe(o,2),i=s[0],l=s[1],u=v.useState(a.position||"right"),c=fe(u,2),f=c[0],g=c[1],p=v.useState(""),b=fe(p,2),h=b[0],x=b[1],m=v.useState(!1),y=fe(m,2),w=y[0],C=y[1],k=i&&a.closeOnEscape,H=br("tooltip",k),W={props:a,state:{visible:i,position:f,className:h},context:{right:f==="right",left:f==="left",top:f==="top",bottom:f==="bottom"}},L=je.setMetaData(W),A=L.ptm,K=L.cx,Z=L.sx,ie=L.isUnstyled;Ve(je.css.styles,ie,{name:"tooltip"}),Sr({callback:function(){Q()},when:k,priority:[Er.TOOLTIP,H]});var j=v.useRef(null),se=v.useRef(null),$=v.useRef(null),G=v.useRef(null),le=v.useRef(!0),R=v.useRef({}),de=v.useRef(null),ve=Pr({listener:function(d){!P.isTouchDevice()&&Q(d)}}),mt=fe(ve,2),Sn=mt[0],On=mt[1],Pn=Or({target:$.current,listener:function(d){Q(d)},when:i}),yt=fe(Pn,2),Cn=yt[0],Tn=yt[1],Nn=function(d){return!(a.content||z(d,"tooltip"))},An=function(d){return!(a.content||z(d,"tooltip")||a.children)},qe=function(d){return z(d,"mousetrack")||a.mouseTrack},bt=function(d){return z(d,"disabled")==="true"||xt(d,"disabled")||a.disabled},ht=function(d){return z(d,"showondisabled")||a.showOnDisabled},Pe=function(){return z($.current,"autohide")||a.autoHide},z=function(d,E){return xt(d,"data-pr-".concat(E))?d.getAttribute("data-pr-".concat(E)):null},xt=function(d,E){return d&&d.hasAttribute(E)},wt=function(d){var E=[z(d,"showevent")||a.showEvent],_=[z(d,"hideevent")||a.hideEvent];if(qe(d))E=["mousemove"],_=["mouseleave"];else{var T=z(d,"event")||a.event;T==="focus"&&(E=["focus"],_=["blur"]),T==="both"&&(E=["focus","mouseenter"],_=w?["blur"]:["mouseleave","blur"])}return{showEvents:E,hideEvents:_}},Et=function(d){return z(d,"position")||f},kn=function(d){var E=z(d,"mousetracktop")||a.mouseTrackTop,_=z(d,"mousetrackleft")||a.mouseTrackLeft;return{top:E,left:_}},St=function(d,E){if(se.current){var _=z(d,"tooltip")||a.content;_?(se.current.innerHTML="",se.current.appendChild(document.createTextNode(_)),E()):a.children&&E()}},Ot=function(d){St($.current,function(){var E=de.current,_=E.pageX,T=E.pageY;a.autoZIndex&&!me.get(j.current)&&me.set("tooltip",j.current,n&&n.autoZIndex||ae.autoZIndex,a.baseZIndex||n&&n.zIndex.tooltip||ae.zIndex.tooltip),j.current.style.left="",j.current.style.top="",Pe()&&(j.current.style.pointerEvents="none");var N=qe($.current)||d==="mouse";(N&&!G.current||N)&&(G.current={width:P.getOuterWidth(j.current),height:P.getOuterHeight(j.current)}),Pt($.current,{x:_,y:T},d)})},Ce=function(d){d.type&&d.type==="focus"&&C(!0),$.current=d.currentTarget;var E=bt($.current),_=An(ht($.current)&&E?$.current.firstChild:$.current);if(!(_||E))if(de.current=d,i)Te("updateDelay",Ot);else{var T=Ne(a.onBeforeShow,{originalEvent:d,target:$.current});T&&Te("showDelay",function(){l(!0),Ne(a.onShow,{originalEvent:d,target:$.current})})}},Q=function(d){if(d&&d.type==="blur"&&C(!1),Tt(),i){var E=Ne(a.onBeforeHide,{originalEvent:d,target:$.current});E&&Te("hideDelay",function(){!Pe()&&le.current===!1||(me.clear(j.current),P.removeClass(j.current,"p-tooltip-active"),l(!1),Ne(a.onHide,{originalEvent:d,target:$.current}))})}else!a.onBeforeHide&&!Ct("hideDelay")&&l(!1)},Pt=function(d,E,_){var T=0,N=0,Y=_||f;if((qe(d)||Y=="mouse")&&E){var ee={width:P.getOuterWidth(j.current),height:P.getOuterHeight(j.current)};T=E.x,N=E.y;var kt=kn(d),Ae=kt.top,ke=kt.left;switch(Y){case"left":T=T-(ee.width+ke),N=N-(ee.height/2-Ae);break;case"right":case"mouse":T=T+ke,N=N-(ee.height/2-Ae);break;case"top":T=T-(ee.width/2-ke),N=N-(ee.height+Ae);break;case"bottom":T=T-(ee.width/2-ke),N=N+Ae;break}T<=0||G.current.width>ee.width?(j.current.style.left="0px",j.current.style.right=window.innerWidth-ee.width-T+"px"):(j.current.style.right="",j.current.style.left=T+"px"),j.current.style.top=N+"px",P.addClass(j.current,"p-tooltip-active")}else{var Ge=P.findCollisionPosition(Y),Fn=z(d,"my")||a.my||Ge.my,Hn=z(d,"at")||a.at||Ge.at;j.current.style.padding="0px",P.flipfitCollision(j.current,d,Fn,Hn,function(Je){var jt=Je.at,Qe=jt.x,Wn=jt.y,Bn=Je.my.x,_t=a.at?Qe!=="center"&&Qe!==Bn?Qe:Wn:Je.at["".concat(Ge.axis)];j.current.style.padding="",g(_t),jn(_t),P.addClass(j.current,"p-tooltip-active")})}},jn=function(d){if(j.current){var E=getComputedStyle(j.current);d==="left"?j.current.style.left=parseFloat(E.left)-parseFloat(E.paddingLeft)*2+"px":d==="top"&&(j.current.style.top=parseFloat(E.top)-parseFloat(E.paddingTop)*2+"px")}},_n=function(){Pe()||(le.current=!1)},In=function(d){Pe()||(le.current=!0,Q(d))},$n=function(d){if(d){var E=wt(d),_=E.showEvents,T=E.hideEvents,N=Nt(d);_.forEach(function(Y){return N==null?void 0:N.addEventListener(Y,Ce)}),T.forEach(function(Y){return N==null?void 0:N.addEventListener(Y,Q)})}},Ln=function(d){if(d){var E=wt(d),_=E.showEvents,T=E.hideEvents,N=Nt(d);_.forEach(function(Y){return N==null?void 0:N.removeEventListener(Y,Ce)}),T.forEach(function(Y){return N==null?void 0:N.removeEventListener(Y,Q)})}},Ct=function(d){return z($.current,d.toLowerCase())||a[d]},Te=function(d,E){Tt();var _=Ct(d);_?R.current["".concat(d)]=setTimeout(function(){return E()},_):E()},Ne=function(d){if(d){for(var E=arguments.length,_=new Array(E>1?E-1:0),T=1;T<E;T++)_[T-1]=arguments[T];var N=d.apply(void 0,_);return N===void 0&&(N=!0),N}return!0},Tt=function(){Object.values(R.current).forEach(function(d){return clearTimeout(d)})},Nt=function(d){if(d){if(ht(d)){if(!d.hasWrapper){var E=document.createElement("div"),_=d.nodeName==="INPUT";return _?P.addMultipleClasses(E,"p-tooltip-target-wrapper p-inputwrapper"):P.addClass(E,"p-tooltip-target-wrapper"),d.parentNode.insertBefore(E,d),E.appendChild(d),d.hasWrapper=!0,E}return d.parentElement}else if(d.hasWrapper){var T;(T=d.parentElement).replaceWith.apply(T,sa(d.parentElement.childNodes)),delete d.hasWrapper}return d}return null},Rn=function(d){Ze(d),Xe(d)},Xe=function(d){At(d||a.target,$n)},Ze=function(d){At(d||a.target,Ln)},At=function(d,E){if(d=S.getRefElement(d),d)if(P.isElement(d))E(d);else{var _=function(N){var Y=P.find(document,N);Y.forEach(function(ee){E(ee)})};d instanceof Array?d.forEach(function(T){_(T)}):_(d)}};Ue(function(){i&&$.current&&bt($.current)&&Q()}),ce(function(){return Xe(),function(){Ze()}},[Ce,Q,a.target]),ce(function(){if(i){var O=Et($.current),d=z($.current,"classname");g(O),x(d),Ot(O),Sn(),Cn()}else g(a.position||"right"),x(""),$.current=null,G.current=null,le.current=!0;return function(){On(),Tn()}},[i]),ce(function(){var O=Et($.current);i&&O!=="mouse"&&Te("updateDelay",function(){St($.current,function(){Pt($.current)})})},[a.content]),ge(function(){Q(),me.clear(j.current)}),v.useImperativeHandle(t,function(){return{props:a,updateTargetEvents:Rn,loadTargetEvents:Xe,unloadTargetEvents:Ze,show:Ce,hide:Q,getElement:function(){return j.current},getTarget:function(){return $.current}}});var Dn=function(){var d=Nn($.current),E=e({id:a.id,className:U(a.className,K("root",{positionState:f,classNameState:h})),style:a.style,role:"tooltip","aria-hidden":i,onMouseEnter:function(Y){return _n()},onMouseLeave:function(Y){return In(Y)}},je.getOtherProps(a),A("root")),_=e({className:K("arrow"),style:Z("arrow",ga({},W))},A("arrow")),T=e({className:K("text")},A("text"));return v.createElement("div",We({ref:j},E),v.createElement("div",_),v.createElement("div",We({ref:se},T),d&&a.children))};if(i){var Mn=Dn();return v.createElement(sn,{element:Mn,appendTo:a.appendTo,visible:!0})}return null}));cn.displayName="Tooltip";function be(){return be=Object.assign?Object.assign.bind():function(r){for(var t=1;t<arguments.length;t++){var e=arguments[t];for(var n in e)({}).hasOwnProperty.call(e,n)&&(r[n]=e[n])}return r},be.apply(null,arguments)}function Se(r){"@babel/helpers - typeof";return Se=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},Se(r)}function va(r,t){if(Se(r)!="object"||!r)return r;var e=r[Symbol.toPrimitive];if(e!==void 0){var n=e.call(r,t);if(Se(n)!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(r)}function ma(r){var t=va(r,"string");return Se(t)=="symbol"?t:t+""}function te(r,t,e){return(t=ma(t))in r?Object.defineProperty(r,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):r[t]=e,r}var ya={root:function(t){var e=t.props;return U("p-badge p-component",te({"p-badge-no-gutter":S.isNotEmpty(e.value)&&String(e.value).length===1,"p-badge-dot":S.isEmpty(e.value),"p-badge-lg":e.size==="large","p-badge-xl":e.size==="xlarge"},"p-badge-".concat(e.severity),e.severity!==null))}},ba=`
@layer primereact {
    .p-badge {
        display: inline-block;
        border-radius: 10px;
