...
export const ColorTextInverse = "#0f172a";
export const ColorTextMuted = "#64748b";
export const ColorBackgroundApp = "#020617";
export const ColorBackgroundSurface = "#0f172a";
export const ColorBackgroundCard = "#1e293b";
export const ColorBackgroundInverse = "#f8fafc";
export const ColorBorderDefault = "rgba(255,255,255,0.08)";
export const ColorBorderStrong = "rgba(255,255,255,0.16)";
export const ColorBorderFocus = "#60a5fa";
export const ColorAccentPrimary = "#60a5fa";
export const ColorAccentHover = "#93c5fd";
export const ColorAccentActive = "#bfdbfe";
export const ColorStateSuccess = "#22c55e";
export const ColorStateDanger = "#ef4444";
export const ColorStateWarning = "#facc15";
export const ColorStateInfo = "#06b6d4";
